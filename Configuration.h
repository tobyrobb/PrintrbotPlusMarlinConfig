...
#define STRING_CONFIG_H_AUTHOR "(Toby, Printrbot Plus)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2000, 100, 100 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 100, 100, 5 }
...
// - If steppeFr drivers time out, it will need X and Y homing again before Z homing.
